...
const Post = ({ post }) => {
  ...
  return (
    <div className="w-full px-2 sm:px-4 md:px-0 flex justify-center">
      <div className="bg-neutral-900 rounded-xl shadow-md w-full max-w-[500px] border border-neutral-800 mb-6">
        {/* Header */}
        ...
        {/* Action Buttons */}
        <div className="flex items-center justify-between px-4 pt-3 mt-1 text-white text-lg">
          <div className="flex gap-4 items-center">
            ...
            <MessageCircle
              ...
              className="cursor-pointer hover:text-blue-400 transition w-6 h-6"
            />
            <Send className="cursor-pointer hover:text-green-400 transition w-6 h-6" />
          </div>
          <Bookmark className="cursor-pointer hover:text-yellow-400 transition w-6 h-6" />
        </div>
        ...
        <p
          ...
          className="px-4 text-sm text-gray-400 cursor-pointer hover:underline"
        >
          {post?.comments?.length || 0} <span>Comments...</span>
        </p>
