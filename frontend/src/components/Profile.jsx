...
//   const [activeTags, setActiveTags] = useState("posts");
//   const handleTypeChange = (tab) => setActiveTags(tab);

//   // ✅ Hamesha array fallback
//   const displayUserPosts =
//     (activeTags === "posts" ? displayUser?.posts : displayUser?.bookmarks) ||
//     [];
...
//                 <span>
//                   <strong>{displayUser?.followers?.length || 0}</strong>{" "}
//                   Followers
//                 </span>
//                 <span>
//                   <strong>{displayUser?.following?.length || 0}</strong>{" "}
//                   Following
//                 </span>
//                 <span>
...
//               {activeTags === "posts" ? "No posts yet." : "No saved posts yet."}
//             </div>
//           ) : (
